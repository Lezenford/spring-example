...
/**
 * Точка входа для Spring приложения. Именно класс {@link AbstractAnnotationConfigDispatcherServletInitializer} позволяет запустить Spring
 * приложение внутри контейнера сервлетов TomCat
 */
